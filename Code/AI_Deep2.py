...
# 파일 경로 설정
input_path = '/content/drive/MyDrive/Colab Notebooks/P프끝/식단운동합침77.csv'
...
features = [
    ...
    '총 식사섭취 칼로리', 'ActivityLevel', 'WeightDifference', 'DaysToGoal'
]
...
feature_path = "/content/drive/MyDrive/Colab Notebooks/P프끝/라스트7feature_columns.json"
with open(feature_path, 'w') as f:
    json.dump(feature_columns, f)
print(f"Feature 목록 저장 완료: {feature_path}")

# 2. Scaler 저장
scaler_path = "/content/drive/MyDrive/Colab Notebooks/P프끝/라스트7scaler.joblib"
dump(scaler, scaler_path)
print(f"Scaler 저장 완료: {scaler_path}")

# 3. 모델 가중치 저장
model_path = "/content/drive/MyDrive/Colab Notebooks/P프끝/라스트7P_model.pth"
